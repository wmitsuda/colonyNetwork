...
contract ReputationMiningCycleRespond is ReputationMiningCycleStorage, PatriciaTreeProofs, DSMath {
  ...
  function checkKey(uint256[11] u, bytes memory _reputationKey, bytes memory _reputationValue) internal view {
  ...
  function saveProvedReputation(uint256[12] u, bytes previousNewReputationValue) internal {
